...
## Release 2.4.0
- DFM-5032: Return serialized PyArrow IPC streams as `pyarrow.Buffer` objects
...
- Keep Parquet output on ZSTD compression for optimal file sizes.
...
- Unified missing column handling between DuckDB and PyArrow engines
...
- Align requirements over requirements.txt, pyproject.toml and setup.py
